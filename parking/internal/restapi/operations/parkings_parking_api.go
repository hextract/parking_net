...
// NewParkingsParkingAPI creates a new ParkingsParking instance
func NewParkingsParkingAPI(spec *loads.Document) *ParkingsParkingAPI {
	return &ParkingsParkingAPI{
...
/*ParkingsParkingAPI Parking Net Go project | Parking svc */
type ParkingsParkingAPI struct {
	spec            *loads.Document
...
func (o *ParkingsParkingAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *ParkingsParkingAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *ParkingsParkingAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *ParkingsParkingAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *ParkingsParkingAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *ParkingsParkingAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *ParkingsParkingAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *ParkingsParkingAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *ParkingsParkingAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the ParkingsParkingAPI
func (o *ParkingsParkingAPI) Validate() error {
...
func (o *ParkingsParkingAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *ParkingsParkingAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *ParkingsParkingAPI) Authorizer() runtime.Authorizer {
	return o.APIAuthorizer
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *ParkingsParkingAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *ParkingsParkingAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *ParkingsParkingAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the parkings parking API
func (o *ParkingsParkingAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *ParkingsParkingAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/parking"] = parking.NewGetParkings(o.context, o.ParkingGetParkingsHandler)
...
func (o *ParkingsParkingAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *ParkingsParkingAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *ParkingsParkingAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *ParkingsParkingAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *ParkingsParkingAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
